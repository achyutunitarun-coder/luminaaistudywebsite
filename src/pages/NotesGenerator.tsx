          ...
          >
            ...
            <div className="relative rounded-3xl liquid-glass-intense overflow-hidden">
              ...
              <div className="p-8 pt-6">
                <div className="prose prose-invert prose-base max-w-none prose-headings:font-display prose-headings:text-foreground prose-headings:tracking-tight prose-headings:border-b prose-headings:border-border/20 prose-headings:pb-2 prose-p:text-muted-foreground prose-p:leading-[1.85] prose-strong:text-foreground prose-strong:font-semibold prose-li:text-muted-foreground prose-li:leading-[1.75] prose-code:text-primary prose-code:bg-primary/10 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded-md prose-code:text-xs prose-code:font-mono prose-blockquote:border-l-success/50 prose-blockquote:bg-success/5 prose-blockquote:rounded-r-xl prose-blockquote:py-3 prose-blockquote:px-5 prose-blockquote:text-foreground/80 prose-blockquote:not-italic prose-h1:text-2xl prose-h1:mt-0 prose-h2:text-xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-base prose-h3:mt-6 prose-h3:mb-2 prose-h3:border-none prose-hr:border-border/20 prose-hr:my-8 prose-table:text-sm prose-th:text-foreground prose-th:font-semibold prose-th:bg-muted/20 prose-th:px-4 prose-th:py-2.5 prose-td:px-4 prose-td:py-2 prose-td:border-border/20 prose-tr:border-border/15 prose-a:text-primary prose-a:no-underline hover:prose-a:underline prose-img:rounded-xl prose-pre:bg-muted/30 prose-pre:border prose-pre:border-border/20 prose-pre:rounded-xl [&_table]:rounded-xl [&_table]:overflow-hidden [&_table]:border [&_table]:border-border/20 [&_ul]:space-y-1 [&_ol]:space-y-1 [&_li>ul]:mt-1 [&_li>ol]:mt-1 [&_input[type=checkbox]]:mr-2 [&_input[type=checkbox]]:accent-success">
