...
const SettingsPage = () => {
      ...
      <div className="grid grid-cols-2 gap-2">
        {opts.map(opt => (
          <button
            ...
            className={`glass rounded-lg px-4 py-3 text-sm transition-all ${
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="glass rounded-xl p-6 space-y-8">
